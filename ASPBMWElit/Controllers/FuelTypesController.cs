...
namespace ASPBMWElit.Controllers
{
    public class FuelTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,DateRegistered")] FuelType fuelType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,DateRegistered")] FuelType fuelType)
        {
            if (id != fuelType.Id)
            {
                return NotFound();
